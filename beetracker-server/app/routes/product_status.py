...
def get_product_infos(
    ...
    from app.db.autogen.models.product_status import ProductStatus
    ...
    productStatus = db.query(ProductStatus).all()

    return [status.to_schema() for status in productStatus]